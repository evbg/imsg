...
-АН2/Л-С/Н
-УУОО0500
-К0180М0040 ЗОНА АВИАЦИОННО-КОСМИЧЕСКОГО ПОИСКА И СПАСЕНИЯ
В РАЙОНЕ НР1
-УУОО2400 УУОБ
-СТС/SAR ДОФ/131220 РЕГ/17967 ОПР/ЗАО АК ПОЛЕТ
РМК/ПОИСКОВО-СПАСАТЕЛЬНОЕ ОБЕСПЕЧЕНИЕ ПОЛЕТОВ
ФИО/БАБАНИН МИН/150 2,0 450 Ч,0 РЕЗЕРВ АН2/02273 СВЭ/АР-08-10-02 ДО
06.05.2016Г Р-855,АРМ-406П НА БОРТУ
СОГЛАСОВАНО ПРИДАЧА ДИСПЕТЧЕР ВАЙЛАНД СОГЛАСОВАНО БАЛТИМОР ДИСПЕТЧЕР
ТЕРЕЖКИНА СОГЛАСОВАНО МДП ДИСПЕТЧЕР КУЛИК СОГЛАСОВАНО АДП
ДИСПЕТЧЕР ПОЛТАВЧЕНКО СОГЛАСОВАНО ВОРОНЕЖ ПОДХОД ДИСПЕТЧЕР ТИМОХИН)
""",
u"""
(DEP-POT761-UUOO1110-EDDM
DOF/140212 REG/VQBGС КВС/ГОРБУНОВ)
""",
u"""
(ЦНЛ-ПО759-УУДД-УУОО-ДОФ/140222)
""",
u"""
(ФПЛ-ПХ9147-ЖН
-АН2/Л-С/Н
...
В РАЙОНЕ НР1
-УУОО2400 УУОБ
-СТС/SAR ДОФ/140309 РЕГ/17967 ОПР/ЗАО АК ПОЛЕТ
РМК/ПОИСКОВО-СПАСАТЕЛЬНОЕ ОБЕСПЕЧЕНИЕ ПОЛЕТОВ
ФИО/КУРЕИН МИН/150 2,0 450 Ч,0 РЕЗЕРВ АН2/02273 СВЭ/АР-08-10-02 ДО
06.05.2016Г Р-855,АРМ-406П НА БОРТУ
СОГЛАСОВАНО ПРИДАЧА ДИСПЕТЧЕР САФРОНОВ СОГЛАСОВАНО БАЛТИМОР ДИСПЕТЧЕР
БОГОМОЛОВ СОГЛАСОВАНО МДП ДИСПЕТЧЕР ВЛАСЕНКОВ СОГЛАСОВАНО АДП
ДИСПЕТЧЕР КОЗЛОВА СОГЛАСОВАНО ВОРОНЕЖ ПОДХОД ДИСПЕТЧЕР КУЛЕВИЧ)
""",
]
    for msg in messages:
