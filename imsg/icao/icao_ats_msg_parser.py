...
ICAO_MSG_FIELDS_2013 = {
    ...
    # Представленный план полета и связанные с ним обновленные данные
    "FPL": {
        "FIELDS": (3,      7,  8,  9, 10, 13,     15, 16,     18                )
    },
    "SHR": {#
        "FIELDS": (3,      7,             13,     15, 16,     18                )
    },
    "SPW": {#
        "FIELDS": (3,                     13,                 18                )
    },
...
ICAO_MSG_FIELDS = ICAO_MSG_FIELDS_2013
